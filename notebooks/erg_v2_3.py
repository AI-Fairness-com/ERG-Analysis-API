...
Original file is located at
    https://colab.research.google.com/drive/17XZDizHJmiYula9fgDkBUCCSERjFbskd
"""
...
class ERGReportGenerator:
    ...
    def __init__(self, config: ERGConfig = None):
        ...
        # Reference ranges for PhNR (LA 3.0 protocol only)
    ...
    def compute_z_scores(self, features: Dict, electrode_type: str, protocol: str) -> Dict[str, float]:
        ...
        if 'a_wave_amplitude_uv' in features and features['a_wave_amplitude_uv'] and ref['a_amp'][0] > 0:
