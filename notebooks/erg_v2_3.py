# -*- coding: utf-8 -*-
"""Clean_ERG_V2_3.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1qShgVMZKRm3m26C5WjKQNBq9g4XenzKy
"""
...
class ERGReportGenerator:
    ...
    def compute_z_scores(self, features: Dict, electrode_type: str, protocol: str) -> Dict[str, float]:
        ...
        if 'phnr_amp_uv' in features and features['phnr_amp_uv'] and protocol == 'LA 3':
            phnr_ref = self.PHNR_REFERENCE_RANGES.get(electrode_type, (18, 6))
