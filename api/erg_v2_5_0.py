...
print("=" * 60)
print("Features: a-wave amplitude/implicit time, b-wave amplitude/implicit")
print("          time, b/a ratio, OP2-OP4 amplitude + OP-sum + OP2 implicit")
print("          time (DA 3.0/DA 10.0 only), PhNR amplitude + PhNR/b-wave")
print("          ratio (LA 3.0 only), Hurst Exponent, Approximate Entropy,")
print("          6 DWT band-energy descriptors, b-wave ascending/descending")
print("          inflection time+gradient, a-wave descending inflection time,")
print("          peak frequency, spectral entropy (all protocols), harmonic")
print("          ratio (LA 30 Hz only) -- 28 distinct features, 25-27 per")
print("          recording. Matches Chapter 9 canonical design exactly")
print("          (chapters/ch09/feature_extraction_and_selection_pipeline.py)")
print("=" * 60)
